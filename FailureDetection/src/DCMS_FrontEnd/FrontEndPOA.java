...
/**
* DCMS_FrontEnd/FrontEndPOA.java .
...
public abstract class FrontEndPOA extends org.omg.PortableServer.Servant
 implements DCMS_FrontEnd.FrontEndOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("recordCounts", new java.lang.Integer (2));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // DCMS_FrontEnd/FrontEnd/createTRecord
       {
         ...
         String $result = null;
         $result = this.createTRecord (managerID, firstName, lastName, address, phoneNumber, specialization, location);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 1:  // DCMS_FrontEnd/FrontEnd/createSRecord
       {
         String managerID = in.read_string ();
         String firstName = in.read_string ();
         String lastName = in.read_string ();
       ...
       case 2:  // DCMS_FrontEnd/FrontEnd/recordCounts
       {
         String managerID = in.read_string ();
         String $result = null;
         $result = this.recordCounts (managerID);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 3:  // DCMS_FrontEnd/FrontEnd/editRecord
       {
         String managerID = in.read_string ();
       ...
       case 4:  // DCMS_FrontEnd/FrontEnd/transferRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
